...
public class Methods {
	...
	public static RequestSpecification authorization(IAuth Icontext, String apikey, String apiSecret ,String token,String tokenSecret) {

		RequestSpecification reqSpec;
		if (Icontext == null) {
			reqSpec = RestAssured.given();
		} else {
			reqSpec = Icontext.auth(apikey,apiSecret,token,tokenSecret);
		}
		return reqSpec;
	}
	...
	public static RequestSpecification init(Context context) {
		...
		RequestSpecification reqSpec = authorization(context.auth, context.apikey,context.apiSecret,context.token,context.tokenSecret);
